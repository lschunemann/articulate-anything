...
parser.add_argument(
    "--base_path",
    type=str,
    default="/home/leonardophd/workspace/data/PhysTwin/data/different_types"
)
parser.add_argument("--case_name", type=str, default="single_push_rope_1")
...
output_dir = f"{base_path}/{case_name}/shape/matching_temp"
...
if __name__ == "__main__":
    ...
    for i in range(3):
        ...
        pcd_vis.points = o3d.utility.Vector3dVector(points.reshape(-1, 3))
        pcd_vis.colors = o3d.utility.Vector3dVector(colors.reshape(-1, 3))
        o3d.io.write_point_cloud(f"{output_dir}/pcd_{i}.ply", pcd_vis)
