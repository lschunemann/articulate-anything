...
for object in "$@"; do
    ...
    # Step 1: Activate articulate-anything-clean environment and run detect_articulated_parts.py
    echo "Step 1: Running detect_articulated_parts_image.py"
    ...
    # Step 2: Check if output already exists, then run render_mesh.py in Blender if needed
    echo "Step 2: Checking for existing render results"
